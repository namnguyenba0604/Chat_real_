...
import {useFetchRecipientUsers} from "../../hooks/useFetchRoom";
import { unreadNotificationsFunc } from "../../utils/unreadNotifications";
import moment from "moment";

const UserCard = ({ chat, chatRoom, user }) => {
  const { recipientUser } = useFetchRecipientUser(chat, user);
  const { recipientUsers } = useFetchRecipientUsers(chatRoom, user);
      ...
      >
        <div className="d-flex">
          ...
          <div className="text-content">
            <div className="name">{chatRoom?.name || recipientUser?.name}</div>
            <div className="text">
              {latestMessage?.text && (
